        ...
        <table class="min-w-full bg-white border border-gray-200">
            ...
            <tbody class="text-left">
                <?php $__currentLoopData = $constituencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $constituency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="border border-gray-300 px-4 py-2"><?php echo e($constituency['C_Code']); ?></td>
                        <td class="border border-gray-300 px-4 py-2"><?php echo e($constituency['C_Name']); ?></td>
                        <td class="border border-gray-300 px-4 py-2"><?php echo e($constituency['']); ?></td>
                        <td class="border border-gray-300 px-4 py-2"><?php echo e($station['']); ?></td>
                    </tr>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\dashboard\testing\resources\views/constituencies.blade.php ENDPATH**/ ?>